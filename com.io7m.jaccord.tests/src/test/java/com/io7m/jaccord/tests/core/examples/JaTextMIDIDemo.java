...
public final class JaTextMIDIDemo
{
  private JaTextMIDIDemo()
  {
  ...
  public static void main(
    ...
    throws Exception
  {
    final byte[] text_bytes = System.in.readAllBytes();
    ...
    for (final byte b : text_bytes) {
      final long duration = (long) 1 * quarter;
      ...
      {
        final ShortMessage mm = new ShortMessage();
        mm.setMessage(0x80, b, 0x00);
        final MidiEvent me = new MidiEvent(mm, time_next);
        t.add(me);
      }
