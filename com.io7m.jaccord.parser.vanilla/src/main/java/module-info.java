...
/**
 * Vanilla parser implementations.
 */

module com.io7m.jaccord.parser.vanilla
{
  requires transitive com.io7m.jaccord.core;
  requires transitive com.io7m.jaccord.parser.api;
  requires transitive com.io7m.jlexing.core;

  requires com.io7m.junreachable.core;
  requires io.vavr;

  provides JaScaleParserProviderType with JaScaleParsers;
  provides JaChordNoteParserProviderType with JaChordNoteParsers;

  exports com.io7m.jaccord.parser.vanilla;
}